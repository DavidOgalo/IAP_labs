...
class User implements Crud,Authenticator
{
	...
	public function save()
	{
		...
		$offset = $this->offset;
		$res = mysqli_query($con->conn, "INSERT INTO user(first_name,last_name,user_city,username,password,profile_photo,timestamp,user_offset) VALUES('$fn','$ln','$city','$uname','$pass','$pic','$user_utc','$offset')") or die("Error: ".$con->error);
		return $res;
	}
